...
<th><h5>Channel:<form action="ViewChannel.jsp"><input type="hidden" value=<%=fid %> name="fid"><input type="hidden" value=<%=id %> name="stu_id"><button type="submit" class="btn btn-link"><%=rs6.getString("tea_channel") %></button> </form> </h5></th>
</tr>
<%
}
%>
...
<button type="submit" class="btn btn-outline-secondary"><img src="like.jpg" height=30 width=30> </button></form>
</td>
<td>
...
<input type="hidden" value=<%=id %> name="id"> 
<input type="hidden" value=<%=like %> name="flike"> 
<button type="submit" class="btn btn-outline-secondary"><img src="dislike.jpg" height=30 width=30></button></form>
</td>
<td>
