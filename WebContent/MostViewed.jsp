...
try{
    ...
    PreparedStatement ps = con.prepareStatement("select * from channels order by fview desc limit 10 ");
...
%>
	    	...
	    	<td>
	    	<form action="http://localhost:8080/project/File/Player.jsp"><input type="hidden" value=<%=rs.getString("fid") %> name="fid"><button type="submit" class="btn btn-link"><%=rs.getString("fname") %></button> </form><br>
	    	</td>
